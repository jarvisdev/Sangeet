...
function direct1(response1){
  ...
  $.post("signact.php",{username:response1.name,email:response1.id+"@d.com",pwd:"facebook" ,tr:"1"},function(result){
...
alert(mes);
  ...
  <fb:login-button   scope="public_profile,email,user_posts" onlogin="checkLoginState();">SIGN UP WITH FACEBOOK
</fb:login-button>